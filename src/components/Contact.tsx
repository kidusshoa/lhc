    ...
    <div id="contact" className="flex flex-col w-full h-full">
      <div className="text-[#312e2e] md:h-screen h-full w-full flex flex-col items-center justify-center">
        <div className="h-4/5 w-full flex items-center lg:flex-row flex-col md:p-10 p-3 justify-center gap-5">
          <div className="md:w-2/4 w-full h-full shadow-lg shadow-[#903839] p-5 md:p-0 rounded-3xl flex flex-col items-center justify-center gap-5">
            ...
            >
              <input
                ...
                className="rounded border-[#903839] shadow-lg shadow-[#903839]  transition:0.3s p-3 md:w-4/5 box-border focus:border-2 focus:border-[#903839] bg-white text-xl outline-none"
              />
              <input
